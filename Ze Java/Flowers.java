...
public class Flowers extends Icon{
  GraphicsContext gc;
  int x;
  int y;
  ...
  Flowers(Canvas c, int a, int b){
    ...
    gc.fillOval(x+5, y+5, 15, 5);
    gc.fillOval(x+10, y, 15, 5);
    gc.fillOval(x+5, y-5, -15, -5);
    gc.fillOval(x+5, y+5,  -15, -5);
    gc.fillOval(x+10, y, -15, 5);
    gc.fillOval(x+5, y-5, -15, -5);
  ...
  void erase(){
    ...
    gc.clearRect(x+5, y+5, 15, 5);
    gc.clearRect(x+10, y, 15, 5);
    gc.clearRect(x+5, y-5, -15, -5);
    gc.clearRect(x+5, y+5,  -15, -5);
    gc.clearRect(x+10, y, -15, 5);
    gc.clearRect(x+5, y-5, -15, -5);
